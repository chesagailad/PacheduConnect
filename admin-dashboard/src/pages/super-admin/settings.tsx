import { UserCircleIcon, KeyIcon, BellIcon, Cog6ToothIcon } from '@heroicons/react/24/outline';
    ...
    <div className="p-8">
      ...
      <div className="card">
        ...
        <div>
          ...
          <p className="mb-4 text-gray-600">Configure platform-wide settings. (Coming soon)</p>
        </div>
      </div>
    </div>
  );
