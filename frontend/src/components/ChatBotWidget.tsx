 ...
 * Author: Gailad Chesa
 * Created: 2024-01-01
 * Description: ChatBotWidget - handles frontend functionality
 */
            ...
            <div data-testid="chat-messages" className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              {isTyping && (
                <div className="flex justify-start">
                  <div data-testid="loading-indicator" className="bg-gray-100 text-gray-800 rounded-lg rounded-bl-none px-3 py-2 max-w-xs">
